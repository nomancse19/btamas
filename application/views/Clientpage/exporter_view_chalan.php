...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Client/ExporterAllVehiclesRequest">Add & Manage Request</a></li>
    ...
    <section class="content">
      ...
      <!-- end head section -->
      <div>
       <a href="<?php echo base_url();?>Client/ExporterChalanInfo"><button class="btn btn-success" style="margin:10px;float:right;height:40px;">Back All Chalan Info</button></a>
      </div>
      <!-- start form  -->
