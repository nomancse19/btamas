    ...
    <div class="container-flude adjus-width" id="main_print">
      ...
      <div class="headsection row d-flex flex-row">
        ...
        <div class="col-md-8 flex-grow-1 headcenter text-center">
          <span style="font-size:32px;"> মোসার্স চলো ট্রান্সপৌর্ট এজেন্সী</span><br>
          <span class="">পরিবহন কমিশন এজেন্ট দুর্গাপুর রোড, বেনাপোল, যশোর। মোবাইলঃ ০১৯৫৮ ০৫২ ৯৯৯</span><span style="font-size: 16px;">Hot line : 01888 052 999
