    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1>Add Vehicles & Vehicles Owner Data</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12 animated headShake">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Vehicles Info</h3>
                <h3 class="card-title">
              <?php
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="wizard">
                        ...
                        <form action="<?php echo base_url();?>Cholotransportowner/Savevehicles" method="post" id="my_from" class="login-box1" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control form-control-sm" name="vehicles_owner_name" onblur="hasvalue()" required id="vehicles_owner_name" placeholder="Enter Vehicles Owner Name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                             <div class="form-group">
                                              <label for="cnf_name">Vehicles Owner Main Mobile Number<span style="color:red;font-weight:bold;font-size:17px;">*</span></label>
                                              <input type="number" class="form-control form-control-sm" name="vehicles_owner_primary_mobile_number" onblur="hasvalue()" required id="vehicles_owner_primary_mobile_number" placeholder="Enter Vehicles Owner Main Mobile Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                              <div class="form-group">
                                                <label for="cnf_name">Vehicles Owner Optional Mobile <span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_owner_op_mobile_number" required id="vehicles_owner_op_mobile_number" placeholder="Enter Vehicles Owner Optional Mobile Number , Add Mutiple by Adding Coma">
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_owner_address" required id="vehicles_owner_address" placeholder="Enter Vehicles Owner Address">
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_owner_nid_no" required id="vehicles_owner_nid_no" placeholder="Enter Vehicles Owner NID No">
                                              </div>
                                        </div>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_no" onblur="hasvalue()" required id="vehicles_no" placeholder="Enter Vehicles No, DHAKA METRO-BA-11-0418 Or ঢাকা মেট্রো-গ-০৪১৮...">
                                              </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_engine_no" required id="vehicles_engine_no" placeholder="Enter Vehicles Engine No....">
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cnf_name">Vehicles Chassis No<span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_chassis_no" required id="vehicles_chassis_no" placeholder="Enter Vehicles chassis no....">
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cnf_name">Vehicles Fitness Paper No<span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_fitness_paper_no" required id="vehicles_fitness_paper_no" placeholder="Enter Vehicles Fitness Paper No....">
                                              </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_tax_token_no" required id="vehicles_tax_token_no" placeholder="Enter Vehicles tax token no...">
                                              </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_license_no" required id="vehicles_license_no" placeholder="Vehicles License No...">
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="cnf_name">Vehicles GPS Tracking Mobile Number: <span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_gps_mobile_number" onblur="hasvalue()" required id="vehicles_gps_mobile_number" placeholder="Vehicles GPS Tracking Mobile Number...">
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="cnf_name">Vehicles GPS Imei  No: <span style="color:red;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_gps_tracking_id" required id="vehicles_gps_tracking_id" placeholder="Vehicles GPS Imei Number...">
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="cnf_name">Vehicles Brta Paper No <span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_brta_paper_no" required id="vehicles_brta_paper_no" placeholder="Vehicles Brta Paper No...">
                                              </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm"   id="fitness_datepicker"  name="vehicles_fitness_paper_end_date"  placeholder="Vehicles fitness Paper End Date....">
                                              </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="vehicles_tax_token_end_date" id="tax_token_datepicker" >
                                              </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cnf_name">Vehicles Brta Paper End Date <span style="color:black;font-weight:bold;font-size:17px;">*</span></label>
                                                <input type="text" class="form-control form-control-sm" name="vehicles_brta_paper_end_date"  id="brta_paper_datepicker">
                                              </div>
                                    </div>
                                    ...
                                    <li><button type="button" class="btn btn-primary prev-step">Back</button></li>
                                        <li><button type="button" id="submit_btn" class="btn btn-success next-step">Save Vehicles Owner & Vehicles info</button></li>
                                    </ul>
                                </div>
...
$(document).ready(function(){
    ...
    $("#submit_btn").click(function(){  
        ...
        var  vehicles_no = $('#vehicles_no').val();
        var  vehicles_gps_mobile_number = $('#vehicles_gps_mobile_number').val();
        var  vehicles_gps_tracking_id = $('#vehicles_gps_tracking_id').val();
        if(vehicles_gps_tracking_id==''){
            $("#vehicles_gps_tracking_id").css({"border":"2px solid red"});
            $("#vehicles_gps_tracking_id").focus();
        }
        if(vehicles_no==''){
...
<script type="text/javascript">
    ...
    $('#fitness_datepicker').datepicker("setDate", new Date());
    ...
    $('#brta_paper_datepicker').datepicker("setDate", new Date());
    ...
    $('#tax_token_datepicker').datepicker("setDate", new Date());
</script>
