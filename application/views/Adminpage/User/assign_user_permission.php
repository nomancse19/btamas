  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign User Permission</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>Cholotransportowner/Dashboard">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Cholotransportowner/ManageUser">Manage user</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12 animated headShake">
          <div class="card">
            ...
            <div class="card-body">
            <span style="color:blue;font-weight:bold;">Your Are Showing All Permission List...And Set User Permission----</span> <span style="color:green;font-weight:bold;"><?php echo $fullname; ?></span>
            <div class="table-responsive">  
                            <form id="frm-example" action="<?php echo base_url(); ?>Cholotransportowner/SaveAssignUserPermission" method="POST">
                            <input type="hidden" name="<?=UserController::csrf_name();?>" value="<?=UserController::csrf_token();?>" />
                              ...
                              <input type="hidden" value="<?php echo $user_id; ?>" name="user_id">
                                ...
                                <button class="btn btn-primary">Assign Permission In User</button>
                             </form>
...
<?php echo substr($json_user_data, 1, -1); ?>,
      'columnDefs': [{
         'targets': 0,
         'searchable': false,
         'orderable': false,
