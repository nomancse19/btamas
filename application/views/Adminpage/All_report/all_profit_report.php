  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Profit Calculation Report...</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
       ...
       <a href="<?php echo base_url();?>Cholotransportowner/ProfitReport"><button class="btn btn-success">Profit Report</button></a>
            ...
            <form role="form" action="<?php echo base_url();?>Cholotransportowner/GetProfitReport" enctype="multipart/form-data" method="get">
                      <input type="hidden" name="<?=ReportController::csrf_name();?>" value="<?=ReportController::csrf_token();?>" />
                          ...
                          <div class="col-sm-3">
                            ...
                            <label for=""></label>
                            <button type="submit"  class="btn btn-primary form-control ">Get All Profit Report</button>
                            </div>
            ...
            <div>
             <?php
             if(isset($all_profit_data)){
             $total_all_profit_data=count($all_profit_data);

             if($total_all_profit_data>0){
             ?>
   <p>
    ...
    <button class="btn btn-warning" style="text-align:center;margin-left:0%" onclick="savepdf()">Save PDF Report</button>
            ...
            <title>BTAMS - All Profit Details Report..</title>
                 <p style="text-align:center;font-weight:bold;">
                  <span style="font-size:25px;">  BTAMS</span><br>
                  <span style="font-size:19px;"> All Profit Report</span><br>
              ...
              <table class="table table-bordered" style="float: left;width:100%;margin-left:2px;">
                  ...
                  <tr style="font-size:11px;">
                   ...
                   <th width="20%">Date</th>
                   <th width="25%">Name</th>
                   <th width="15%" style="text-align:right;">Original Amount</th>
                   <th width="15%" style="text-align:right;">Sell Amount</th>
                   <th width="15%" style="text-align:right;">Profit Amount</th>
                   </tr>
                  <?php if($all_profit_data){ ?>
                    <?php 
                    $no=0;

                    $income_details_original_amount=0;
                    $income_details_sell_amount=0;
                    ?>
                  <?php foreach($all_profit_data as $all_profit_data_info){ 
                    $income_details_sell_amount=$income_details_sell_amount+$all_profit_data_info->income_details_sell_amount;
                    $income_details_original_amount=$income_details_original_amount+$all_profit_data_info->income_details_original_amount;
                  ...
                  <tr style="font-size:10px;">
                    <td><?php echo $no; ?></td>
                    <td><?php echo $all_profit_data_info->income_details_added_date_time;?></td>
                    <td><?php echo mb_strimwidth($all_profit_data_info->income_category_name.' '.$all_profit_data_info->income_details_id_no, 0, 34, "...");?></td>
                    <td style="text-align:right;"><?php echo $all_profit_data_info->income_details_original_amount;?></td>
                    <td style="text-align:right;"><?php echo $all_profit_data_info->income_details_sell_amount;?></td>
                    <td style="text-align:right;"><?php echo $all_profit_data_info->income_details_sell_amount-$all_profit_data_info->income_details_original_amount;?></td>
                  ...
                  <?php } ?>
                    <tr style="font-size:10px;">
                      ...
                      <td style="text-align:right;font-weight:bold;"><?php echo $income_details_original_amount; ?></td>
                      <td style="text-align:right;font-weight:bold;"><?php echo $income_details_sell_amount; ?></td>
                      <td style="text-align:right;font-weight:bold;"><?php echo $income_details_sell_amount-$income_details_original_amount; ?></td>
