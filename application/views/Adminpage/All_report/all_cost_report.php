...
.box-contents{
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
       ...
       <a href="<?php echo base_url();?>Cholotransportowner/ProfitReport"><button class="btn btn-success">Profit Report</button></a>
            ...
            <form role="form" action="<?php echo base_url();?>Cholotransportowner/GetAllCostReport" enctype="multipart/form-data" method="get">
                      <input type="hidden" name="<?=ReportController::csrf_name();?>" value="<?=ReportController::csrf_token();?>" />
                          ...
                          <div class="col-sm-3">
                            ...
                            <label for=""></label>
                            <button type="submit"  class="btn btn-primary form-control ">Get All Cost Report</button>
                            </div>
    ...
    <button class="btn btn-warning" style="text-align:center;margin-left:0%" onclick="savepdf()">Save PDF Report</button>
            ...
            <title>BTAMS - All Costing Details Report..</title>
                 <p style="text-align:center;font-weight:bold;">
                  <span style="font-size:25px;">  BTAMS</span><br>
                  <span style="font-size:19px;"> All Cost Report</span><br>
