        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Vehicles Request</h3>
              <h3 class="card-title">
              <?php
          ...
          <hr>         
            <table id="datatable" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <td>
                      <textarea style="width:100%;border:none;" readonly> <?php echo $all_vehicles_request_info->vehicles_request_some_note;?></textarea>
                </td>
