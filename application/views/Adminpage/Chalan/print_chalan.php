    ...
    <div class="container-flude adjus-width" id="main_print">
     ...
     <!-- <div class="headsection row d-flex flex-row newdisplay">
        ...
        <div class="col-md-8 flex-grow-1 headcenter text-center">
          <h1>মোসার্স চলো ট্রান্সপৌর্ট এজেন্সী</h1>
          <p class="">পরিবহন কমিশন এজেন্ট দুর্গাপুর রোড, বেনাপোল, যশোর। মোবাইলঃ০১৯৫৮ ০৫২ ৯৯৯</p><h6 style="font-size: 16px;">Hot line : 01888 052 999
