      ...
      <div class="row">
        <div class="col-12 animated headShake">
          <div class="card">
            ...
            <div class="card-body">
            <span style="color:blue;font-weight:bold;">Your Are Showing All Importer User List...And Set Normal Notification----</span> <span style="color:green;font-weight:bold;"><?php echo $selected_normal_info->normal_notification_title; ?></span>
            <div class="table-responsive">  
                            <form id="frm-example" action="<?php echo base_url(); ?>Cholotransportowner/SaveAssignNormalNotificationInImporterUser" method="POST">
                            <input type="hidden" name="<?=NotificationController::csrf_name();?>" value="<?=NotificationController::csrf_token();?>" />
                              ...
                              <input type="hidden" value="<?php echo $selected_normal_info->normal_notification_id; ?>" name="normal_notification_id">
                                ...
                                <button class="btn btn-primary">Assign Importer User In Normal Notification</button>
                             </form>
