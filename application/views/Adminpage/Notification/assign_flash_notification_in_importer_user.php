      ...
      <div class="row">
        <div class="col-12 animated headShake">
          <div class="card">
            ...
            <div class="card-body">
            <span style="color:blue;font-weight:bold;">Your Are Showing All Importer User List...And Set Flash Notification----</span> <span style="color:green;font-weight:bold;"><?php echo $selected_flash_info->flash_notification_title; ?></span>
            <div class="table-responsive">  
                            <form id="frm-example" action="<?php echo base_url(); ?>Cholotransportowner/SaveAssignFlashNotificationInImporterUser" method="POST">
                            <input type="hidden" name="<?=NotificationController::csrf_name();?>" value="<?=NotificationController::csrf_token();?>" />
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Created Date</th>
                                        <th>Importer Full Name</th>
                                        <th>Mobile Number</th>
                                    </tr>
                                </thead>
                                </table>
                                  <hr>
                              <input type="hidden" value="<?php echo $selected_flash_info->flash_notification_id; ?>" name="flash_notification_id">
    
                                <button class="btn btn-primary">Assign Importer User In Flash Notification</button>
                             </form>
