        ...
        <div class="row">
              ...
              <!-- form start -->
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="importer_full_name" readonly value="<?php echo $edit_importer_data->importer_full_name;?>" required id="importer_full_name" placeholder="Enter Transport Malik Name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="importer_op2_mobile_number" readonly id="importer_op2_mobile_number" value="<?php echo $edit_importer_data->importer_op2_mobile_number;?>" placeholder="Enter Transport Malik Blood Groupr , You Can Add Multiple Separate By coma">
                  </div>
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="importer_user_name" readonly id="importer_user_name" value="<?php echo $edit_importer_data->importer_user_name;?>" placeholder="Enter Transport Malik User Name">
                  </div>
          ...
          <div class="col-sm-6">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="importer_mobile_number">NID Card Back Side Picture <span style="color:black;font-weight:bold;font-size:17px;">*</span></label><br>
